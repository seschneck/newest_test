...
We create tables using the kableExtra package.  You can embed a table from a notebook in the same way you do a figure:

{{< embed notebooks/tables.qmd#table-1 >}} 

Alternatively, you can use `kableExtra::save_kable()` in your notebook to output a .png file, which can then be linked as any image is linked. In the notebook you will see specifications for high-resolution output.

![Table as Image](images/table2.png){#tbl-history}
